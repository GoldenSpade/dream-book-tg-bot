  ...
  if (!access.granted) {
    ...
    return safeReply(ctx, () =>
      ctx.replyWithPhoto(
        ...
        {
          caption:
            '🚫 <b>Нет доступа к гаданию. Ежедневный лимит исчерпан.</b>\n\n' +
            ...
            'зачисление <b>не произойдёт</b> пока всё не потратите.\n\n' +
            '🔢 Отстаток лимитов можете посмотреть в меню «👤 Мой аккаунт», в главном меню.',
          parse_mode: 'HTML',
          reply_markup: {
            inline_keyboard: [
              [Markup.button.callback('⏪ В главное меню', 'back_to_menu')],
        ...
        { source: gifBuffer },
        {
          ...
          reply_markup: {
            inline_keyboard: [
              ...
              [Markup.button.callback('⏪ В меню гаданий', 'menu_fortune')],
            ],
          },
        }
      )
